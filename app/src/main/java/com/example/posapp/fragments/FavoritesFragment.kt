...
import com.example.posapp.adapters.FavoritesMealsAdapter
import com.example.posapp.databinding.FragmentFavoritesBinding
...
class FavoritesFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Favorite item delete (set left, right, up , down)
        val itemTouchHelper = object : ItemTouchHelper.SimpleCallback(
            ...
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                ...
                Snackbar.make(requireView(), "Meal Remove!!", Snackbar.LENGTH_SHORT).show()
//                    .setAction(
//                    "Undo",
